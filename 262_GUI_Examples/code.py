...
class Chatbot(Frame):
    ...
    def Letchat(self):
        ...
        self.lstList1 = Listbox(x1, background="#8EC7F5", fg="black",selectbackground="#b9cced",highlightcolor="Red", width=54,height=36,exportselection = 0, yscrollcommand = self.scrollbar1.set)
